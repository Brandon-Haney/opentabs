...
- **`__SKILL__.md`**: Contains the full skill instructions — the plugin development workflow, code patterns, and verification steps. This is the file to edit when updating the skill.
...
- The Plugin SDK API surface changes
- The `opentabs plugin create` scaffolding template changes
- The `opentabs-plugin build` workflow changes
- New common auth extraction patterns are discovered
- The plugin conventions or file structure changes
- New plugins are built that reveal better patterns or new gotchas

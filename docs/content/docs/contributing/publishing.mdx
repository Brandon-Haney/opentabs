...
I publish the platform packages as private packages to the npm registry under the `@opentabs-dev` org. The process is mostly automated, but there are enough moving parts that I wrote it all down. Here's the full workflow.

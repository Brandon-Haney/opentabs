...
Every OpenTabs plugin extends `OpenTabsPlugin` from the SDK. This class defines your plugin's identity, URL matching, readiness probe, and tool registrations.

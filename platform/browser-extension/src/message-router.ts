...
import {
  ...
  handleBrowserFetchInFrame,
  handleBrowserFocusTab,
  handleBrowserForcePseudoState,
  handleBrowserFrameBridgeRpc,
...
const methodHandlers = new Map<string, MessageHandler>([
  ...
  ['browser.fetchInFrame', wrapAsync('browser.fetchInFrame', handleBrowserFetchInFrame)],
  ['browser.frameBridgeRpc', wrapAsync('browser.frameBridgeRpc', handleBrowserFrameBridgeRpc)],

# opentabs-plugin-fidelity

OpenTabs plugin for Fidelity Investments
...
```json
{
  "name": "opentabs-plugin-fidelity",
  "main": "dist/adapter.iife.js",
  "opentabs": {
    "displayName": "Fidelity",
    "description": "OpenTabs plugin for Fidelity Investments",
    "urlPatterns": ["*://*.digital.fidelity.com/*"]
  }
}
```

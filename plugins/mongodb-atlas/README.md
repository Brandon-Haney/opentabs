# opentabs-plugin-mongodb-atlas

OpenTabs plugin for MongoDB Atlas
...
```json
{
  "name": "opentabs-plugin-mongodb-atlas",
  "main": "dist/adapter.iife.js",
  "opentabs": {
    "displayName": "MongoDB Atlas",
    "description": "OpenTabs plugin for MongoDB Atlas",
    "urlPatterns": ["*://*.cloud.mongodb.com/*"]
  }
}
```

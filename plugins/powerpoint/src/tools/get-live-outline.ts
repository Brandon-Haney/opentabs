...
export const getLiveOutline = defineTool({
  ...
  description:
    'Read the LIVE state of the deck that is OPEN in the browser: the current slide list, every paragraph with the ' +
    'shape it belongs to and its per-run formatting (size, bold, italic, underline, color, font), and the shape ' +
    'names. Unlike `get_slides` and ' +
